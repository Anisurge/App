...
val SETTINGS_SEARCH_ENTRIES = listOf(
    ...
    SettingsSearchEntry("backup", "Backup and restore", "Sync", listOf("export", "import", "library", "settings"), SettingsTab.Sync),
    ...
    SettingsSearchEntry("notifications", "Notifications", "Notifications", listOf("episode", "announcement", "airing"), SettingsTab.Notifications),
