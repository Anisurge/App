...
val FALLBACK_SERVERS = listOf(
    ...
    ServerInfo(id = "flix", label = "Flix", type = "sub_dub", active = true),  // HLS (direct m3u8 via proxy + IP token from scraper)
    ...
    ServerInfo(id = "flix-if", label = "Flix-IF", type = "sub_dub", active = true, playerType = PlayerType.WEBVIEW),  // embed/iframe version
)
